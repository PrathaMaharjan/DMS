...
export default function DoctorSettingsTab() {
    ...
    function handleImageChange(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        update("imageUrl", url);
        // Note: this only previews locally. Swap in a real upload call (e.g. to
        // /api/settings/doctor/avatar) if you want the photo persisted server-side.
    }
                    ...
                    <div className="overflow-hidden rounded-2xl border border-slate-900/5 bg-white shadow-sm">
                        ...
                        <form onSubmit={handleSaveProfile} className="border-b border-slate-900/5 p-6 sm:p-7">
                            <div className="mb-6">
                                ...
                                <p className="text-xs text-slate-500">This is how patients and staff see you.</p>
                            </div>
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                ...
                                <label className="block">
                                    <FieldLabel icon={<IdCard className="h-3.5 w-3.5" strokeWidth={2} />}>
                                        Doctor ID
                                    </FieldLabel>
                                    <input
                                        disabled
                            ...
                            <div className="mt-7 border-t border-slate-100 pt-6">
                                ...
                                <p className="text-xs text-slate-500">Your specialty, credentials, and experience.</p>
                            </div>
