...
export default function AdminSettingsPage() {
    ...
    const stats = useMemo(() => {
        return [
            { icon: UserCheck, label: "Account Status", value: "Active", trend: "Full access permissions" },
            { icon: Shield, label: "Role", value: "Administrator", trend: "System-wide controls" },
            { icon: KeyRound, label: "Security Level", value: "High", trend: "Password & session active" },
            { icon: ShieldCheck, label: "Two-Factor Auth", value: "Enabled", trend: "Protected workspace" },
        ];
    }, []);
