...
export default function SuperAdminDashboardPage() {
    const [organizations] = useState<Organization[]>(STATIC_ORGS);
    ...
    const [orgStatuses, setOrgStatuses] = useState<Record<string, OrgStatus>>(
        Object.fromEntries(STATIC_ORGS.map((o) => [o.id, o.status]))
    );

    const growthData = STATIC_GROWTH_BY_YEAR[String(growthYear)] ?? [];
    ...
    const stats = useMemo(() => {
        ...
        const active = organizations.filter((o) => orgStatuses[o.id] === "Active").length;
            ...
            <div className="relative mx-auto max-w-[1600px] space-y-6 px-6 pb-10 pt-6 lg:px-10">
                ...
                <div className="grid gap-4 sm:grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="rounded-2xl border border-slate-900/5 bg-white p-5 shadow-sm transition-all hover:shadow-md">
                        ...
                        <p className="mt-3 text-2xl font-bold text-slate-900">{stats.active}</p>
                    </div>
